...
const AboutUs = () => {
  ...
  return (
    <section className="bg-[#F8F4F3] dark:bg-card pt-16 2xl:pt-[120px]">
      ...
      <div className="mt-12 flex justify-center items-center gap-3 lg:gap-16">
        {
          data.map((item, index) => (
            <div
      ...
      <div className="mt-12 flex flex-wrap justify-center gap-9 text-center">
        ...
        <div className="bg-background border border-primary py-5 px-6 rounded">
          ...
          <span className="block mt-1 text-sm font-medium text-default-800 whitespace-nowrap">Loveyo-digitals</span>
        </div>
        <div className="bg-background border border-primary py-5 px-6 rounded">
