        ...
        <div className="col-span-12 xl:col-span-8">
          <Card>
            <CardContent>
              <div className="flex gap-6 flex-col md:flex-row pt-8">
                <div className="flex-1">
                  <Link href="#">
                    ...
                    <span className="text-3xl font-bold text-primary-600">yodigitals</span>
                  </Link>
                  <div className="mt-5">
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      {
                        columns.map(column => (
                          <TableHead key={`invoice-table-${column.key}`} className="text-default-600 last:text-right">
                            {column.label}
                          </TableHead>
                        ))
                      }
                  ...
                  <TableBody className="[&_tr:last-child]:border-1">
                    {data.map((item, index) => (
                      <TableRow key={`invoice-description-${index}`} >
                        ...
                        <TableCell className="text-right text-sm font-medium text-default-600">${item.amount}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
              ...
              <div className="text-xs text-default-800 mt-2">yodigitals@best.com</div>
              <div className="text-xs text-default-800 mt-1">+880 624279888</div>
              <div className="mt-8 text-xs text-default-800">© 2024 yodigitals</div>
            </CardContent>
          </Card>
          <div className="mt-8 flex gap-4 justify-end">
            ...
            <Button className="text-xs font-semibold ">
              <Icon icon="heroicons:printer" className="w-5 h-5 mr-1" /> Print
            </Button>
          </div>
        </div>
        <div className="col-span-12 xl:col-span-4">
          <Card>
            <CardHeader className="py-6">
              <CardTitle className="text-lg font-medium text-default-700">Payment Method</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-base font-medium text-default-800 mb-6">Credit/Debit Card</div>
              <div className="space-y-5">
                <div className="flex">
                  <div className="text-sm font-medium text-default-600 min-w-[128px]">Card Holder Name:</div>
                  <div className="text-sm font-medium text-default-700 ml-8">Prantik Chakraborty</div>
                </div>
                <div className="flex">
                  <div className="text-sm font-medium text-default-600 min-w-[128px]">Card Number:</div>
                  <div className="text-sm font-medium text-default-700 ml-8">
                    777 888 999 XXX
                  </div>
                </div>
                <div className="flex">
                  <div className="text-sm font-medium text-default-600 min-w-[128px]">Total Amount:</div>
                  <div className="text-sm font-medium text-primary-500 ml-8"> $2019.22</div>
                </div>
                <div className="flex">
                  <div className="text-sm font-medium text-default-600 min-w-[128px]">Due Date:</div>
                  <div className="text-sm font-medium text-primary-500 ml-8"> 2024-04-15</div>
                </div>
                <div className="flex">
                  <div className="text-sm font-medium text-default-600 min-w-[128px]">Invoice Status:</div>
                  <div className="ml-8"><Badge className="text-green-600 bg-green-100 rounded">Confirmed</Badge></div>
                </div>
              </div>
