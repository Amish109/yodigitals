      ...
      <div>
        ...
        <div id="recaptcha-container"></div>
          ...
          <div className="w-120 flex flex-col gap-4 rounded-lg p-4">
            ...
            <p style={{textAlign:"center" , fontSize:"17px"}}>Thank you for registering on our website!  <br /> Here's your promotional code for your first purchase.</p>
            {showOTP ? (
              <>
              ...
              <>
                ...
                <PhoneInput className="mx-12" country={"in"} value={ph} onChange={setPh} />
