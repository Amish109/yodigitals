...
Before you start installing yodigitals, make sure you have a folder ready where you can open the downloaded `.zip` file.
...
#### 1. Demo: `yodigitals-vX.X.X.zip`

This `.zip` file has the Demo version inside, which has all the apps, pages, and UI sections from the Demo app.

#### 2. Starter: `yodigitals-starter-vX.X.X.zip`

This `.zip` file has the Starter version inside, which has all the main parts and features of yodigitals, but without the Demo apps, pages, and UI sections. Use the Starter version to build your app on top.
